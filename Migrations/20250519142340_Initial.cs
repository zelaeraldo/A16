        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrganizerProfiles_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceHistories_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventScheduleItems_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventTagAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventTagAssignments_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventTagAssignments_EventTags_TagId",
                        column: x => x.TagId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceHistories_EventId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventScheduleItems_EventId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventTagAssignments_EventId",
                table: "EventTagAssignments",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_EventTagAssignments_TagId",
                table: "EventTagAssignments",
                column: "TagId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizerProfiles_UserId1",
