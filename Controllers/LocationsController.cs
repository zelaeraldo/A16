...
namespace A16.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,VenueName,Address,City,Country")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VenueName,Address,City,Country")] Location location)
        {
            if (id != location.Id)
            {
                return NotFound();
